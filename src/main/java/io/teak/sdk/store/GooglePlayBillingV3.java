...
public class GooglePlayBillingV3 implements IStore {
    private final BillingClient billingClient;

    public GooglePlayBillingV3(Context context) {
        this.billingClient = BillingClient.newBuilder(context).build();
    ...
    public void processPurchase(String purchaseDataAsString, Map<String, Object> extras) {
        ...
        final Map<String, Object> payload = (extras == null ? new HashMap<String, Object>() : extras);
        ...
        final SkuDetailsParams params = SkuDetailsParams
                ...
                .build();
        this.billingClient.querySkuDetailsAsync(params, new SkuDetailsResponseListener() {
            @Override
