...
htmlhelp_basename = 'TeakAndroiddoc'
...
latex_documents = [
    (master_doc, 'TeakAndroid.tex', u'Teak for Android Documentation',
     u'Teak', 'manual'),
]
...
man_pages = [
    (master_doc, 'teakandroid', u'Teak for Android Documentation',
     [author], 1)
]
